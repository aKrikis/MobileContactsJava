...
public interface IMobileContactService {
    ...
    MobileContact getContactByPhoneNum(String phoneNum) throws ContactNotFoundException;
    void deleteContactByPhoneNumber(String phoneNum) throws ContactNotFoundException;
